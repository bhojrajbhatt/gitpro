...
<div class="content">
  ...
  <form name="frmtestimonial" action="njsss-members/submit/ok" method="post" enctype="multipart/form-data"  id="members">
  
  
    <table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      
      <tr><td style="color:#E10000; font-size:18px; margin-bottom:10px;"><h2>Our members:</h2></td></tr>
      <tr>
        <td style="padding-top:10px;">
				...
				{?>
               			<div class="col-sm-3 col-md-3 col-lg-3">
                        		<div class="serviceBox_2" style="text-align: center;">
                        				<span class="date">
                      						<?php 
									...
									{ ?>
                      				   <img src="<?php echo CMS_TESTIMONIALS_DIR . $arrTests['image']; ?>" width="50%" height="50%" align="left" style="padding-right:5px; margin-left:20%; margin-right:20%;">
                      				<?php } ?>
                                    </center>
                      				<? //echo  nl2br($arrTests['comments']) ?>
                      				<div style="clear:both;"></div>
                      				
            					</div>
                      					<p3><?php echo $arrTests['name']?>, </p3>
                                        <p><?php echo $arrTests['address']; ?>&nbsp;&nbsp;</p> 
                               	</div>
      ...
      <tr>
        <td valign="top" style="padding-left:30px;" ><div id="divform" style="display:block;">
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
              ...
              <tr><td></td></tr>
               <tr>
                <th valign="middle" style="font-weight:bold;">Payment Slip :</th>
                <td valign="middle"><input name="proof" type="file" size="25" /></td>
              </tr>
              <tr><td></td></tr>
              <tr>
              ...
              <tr><td></td></tr>
              <tr>
                <th valign="top" style="font-weight:bold;">About You :<span class="red">*</span></th>
              ...
              <tr>
                ...
                <td valign="middle"><input name="btnmembers" type="submit" class="btnSubmit" value="Send" />
                  <input name="Reset" type="reset" class="btnSubmit" value="Clear" /></td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
                <th align="left" valign="middle">Note:</th>
                <td valign="middle"><span style="color:#D70000;">[ Fields marked with <span class="red">*</span> are compulsory fields ]</span></td>
              </tr>
            </table>
          </div></td>
      </tr>     
