...
<div class="content">
  ...
  <form name="frmtestimonial" action="testimonials/submit/ok" method="post" enctype="multipart/form-data" onsubmit="return testvalidation(this)" id="testimonials">
    ...
    <table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr><td style="color:#E10000; font-size:18px; margin-bottom:10px;"><h2>Articles:</h2></td></tr>
      <tr>
               			...
               			<div class="test">
                        		<div class="testlist">
                     			...
                     			<div>
									...
									{ ?>
                      				   <img src="<?php echo CMS_TESTIMONIALS_DIR . $arrTests['image']; ?>" width="70" height="55" align="left" style="padding-right:5px;">
                      				<?php } ?>
      ...
      <tr>
        <td valign="top" style="font-weight:bold; font-size:15px;"> <a href="javascript:void(0);" onclick="document.getElementById('divform').style.display='block';document.getElementById('tests').style.display='none';" class="cmsTestimonialFormDisplayLink">Submit Your Knowledge</a></td>
      </tr>
      <?php
      ...
      <tr>
        <td valign="top" style="padding-left:30px;" ><div id="divform" style="display:block;">
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
              ...
              <tr><td></td></tr>
              <tr>
                <th valign="top" style="font-weight:bold;">Articles :<span class="red">*</span></th>
               <td valign="middle">  <div id="fckEditor" class="groupBox" >
                                        <?php    
	...
	$oFCKeditor = new FCKeditor('comments');
	$oFCKeditor->BasePath	= $sBasePath ;
	$oFCKeditor->Value		= $groupRow['comments'];
