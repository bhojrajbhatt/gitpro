...
?>
<div style="float: right;"> <a style=" color:#007700; font-size:17px;" href="<?php echo $navNextRow['urlname']; ?>" class="paging">Next &raquo;</a> </div>
<div style="float: right; margin-right:10px;" > <a style=" color:#007700; font-size:17px;" href="<?= $navPreviousRow['urlname']; ?>" class="paging">&laquo; Previous</a> </div>
<div style="clear:both"></div>

<h3 style="margin-top:-2px;"><?php echo $pageName; ?></h3></div>
<div class="content" style="text-align:justify; margin-top:-18px;">
...
<div class="listRow">
  ...
  <div style="padding-top:10px;">
  	<?php
		...
		if($imageGet['image']!="")
		{?>
				<img  width="250" style="padding-right:10px; float:left;" src="<?=CMS_GROUPS_DIR.$imageGet['image'];?>" />
        <?php }?>
