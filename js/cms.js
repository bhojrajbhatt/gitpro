...
function changecargo(cargo)
{ 
	location.href = "cargo.php?groupType=" + cargo.value;
}
function changelocarion(location)
{
	location.href = "location.php?location=" + location.value;
}
